 ...
 */
export declare type ComponentListItem = string | Type<IComponent> | {
    [key: string]: Type<IComponent>;
};
export declare class ComponentRegistry {
    ...
    protected _components: Map<string, IComponent<import("./kinds").ICustomComponentMetadata>>;
    protected _json: {
     ...
     */
    getComponents(): Map<string, IComponent>;
    /**
     ...
     * @param component - instantiated bot component class
     */
    getComponentMethods(component: IComponent): string[];
}
